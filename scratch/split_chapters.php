    ...
    [
        ...
        'sections' => [
            [
                ...
                'steps' => [
                    ['no'=>1, 'text'=>'Tampilan Utama Chatbot',
                    ...
                    ['no'=>2, 'text'=>'Membuka Sidebar Riwayat Chat',
                    ...
                    ['no'=>3, 'text'=>'Tampilan Halaman riwayat chat',
                    ...
                    'img'=>'real_history_chat.png', 'label'=>'LIST HISTORY CHAT'],

                    ['no'=>4, 'text'=>'Menghapus Sesi Chat',
                     ...
                     'img'=>'real_delete_history_chat.png', 'label'=>'KONFIRMASI HAPUS CHAT'],

                    ['no'=>5, 'text'=>'Confirm Delete Chat',
                    ...
                    'img'=>'real_confirm_delete_chat.png', 'label'=>'KONFIRMASI HAPUS CHAT'],
                ],
            ],
        ],
    ],
    ...
    [
        ...
        'sections' => [
            [
                ...
                'steps' => [
                    ['no'=>1, 'text'=>'Dashboard Overview — 4 Kartu Statistik',
                    ...
                    ['no'=>2, 'text'=>'Sidebar Navigasi Admin',
            ...
            [
                ...
                'steps' => [
                    ['no'=>3, 'text'=>'Tombol Toggle Dark/Light Mode',
                    ...
                    ['no'=>4, 'text'=>'Tampilan Dark Mode Aktif',
    ...
    [
        ...
        'sections' => [
            [
                ...
                'steps' => [
                    ['no'=>1, 'text'=>'Halaman Daftar Database',
                    ...
                    ['no'=>2, 'text'=>'Toolbar: Pencarian, Filter, & View Toggle',
                    ...
                    ['no'=>3, 'text'=>'Tombol "Test All Connections"',
                    ...
                    ['no'=>4, 'text'=>'Tombol "Tambah Database"',
            ...
            [
                ...
                'steps' => [
                    ['no'=>5, 'text'=>'Step 1 — Identitas: Nama, Kode & Driver',
                    ...
                    ['no'=>6, 'text'=>'Step 2 — Koneksi: Host, Port, Kredensial & Schema',
                    ...
                    ['no'=>7, 'text'=>'Step 3 — Test Koneksi Sebelum Simpan',
            ...
            [
                ...
                'steps' => [
                    ['no'=>8, 'text'=>'Tombol Edit Database',
                    ...
                    ['no'=>10, 'text'=>'Badge Status Koneksi',
                    ...
                    ['no'=>11, 'text'=>'Copy Host & Nama Database',
                    ...
                    ['no'=>12, 'text'=>'Menghapus Koneksi Database',
    ...
    [
        ...
        'sections' => [
            [
                ...
                'steps' => [
                    ['no'=>1, 'text'=>'Halaman AI Management — Statistik Utama',
                    ...
                    ['no'=>2, 'text'=>'Grid Kartu Provider AI',
            ...
            [
                ...
                'steps' => [
                    ['no'=>3, 'text'=>'Tombol Tambah Provider Baru',
                    ...
                    ['no'=>4, 'text'=>'Modal Form Tambah Provider',
                    ...
                    ['no'=>5, 'text'=>'Toggle Aktif/Nonaktif Provider',
            ...
            [
                ...
                'steps' => [
                    ['no'=>7, 'text'=>'Tab "Keys" pada Kartu Provider',
                    ...
                    ['no'=>8, 'text'=>'Tombol Tambah API Key',
                    ...
                    ['no'=>9, 'text'=>'Modal Form Tambah API Key',
                    ...
                    ['no'=>10, 'text'=>'Tombol Edit API Key',
                    ...
                    ['no'=>11, 'text'=>'Tombol Reset Limit Token',
            ...
            [
                ...
                'steps' => [
                    ['no'=>12, 'text'=>'Tab "Models" pada Kartu Provider',
                    ...
                    ['no'=>13, 'text'=>'Tombol Tambah Model AI',
                    ...
                    ['no'=>14, 'text'=>'Modal Form Tambah Model AI',
            ...
            [
                ...
                'steps' => [
                    ['no'=>15, 'text'=>'Tombol Health Check',
    ...
    [
        ...
        'sections' => [
            [
                ...
                'steps' => [
                    ['no'=>1, 'text'=>'Tampilan Halaman Role Management',
                    ...
                    ['no'=>3, 'text'=>'Modal Form Tambah Role',
            ...
            [
                ...
                'steps' => [
                    ['no'=>4, 'text'=>'Area Pengaturan Permissions',
                    ...
                    ['no'=>5, 'text'=>'Filter Bar Pencarian Tabel',
                    ...
                    ['no'=>6, 'text'=>'Tombol Pilih Semua & Hapus Semua',
                    ...
                    ['no'=>7, 'text'=>'Tombol Simpan Izin Akses',
    ...
    [
        ...
        'sections' => [
            [
                ...
                'steps' => [
                    ['no'=>1, 'text'=>'Halaman Daftar User (Tabel)',
                    ...
                    ['no'=>2, 'text'=>'Header Aksi: Template, Import, Export & Tambah User',
                    ...
                    ['no'=>3, 'text'=>'Filter & Pencarian User',
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no'=>5, 'text'=>'Modal Form Tambah User',
                    ...
                    ['no'=>6, 'text'=>'Field Nama & Email (Wajib Diisi)',
                    ...
                    ['no'=>8, 'text'=>'Tombol Edit User & Modal Edit',
                    ...
                    ['no'=>9, 'text'=>'Modal Edit User — Data Terisi Otomatis',
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no'=>11, 'text'=>'Import User dari File Excel/CSV',
            ...
            [
                ...
                'steps' => [
                    ['no'=>13, 'text'=>'Tombol AI Config (per User)',
                    ...
                    ['no'=>14, 'text'=>'Modal Konfigurasi AI per User',
                     ...
                     'img'=>'real_model_ai_user_management.png', 'label'=>'KONFIGURASI AI PER USER'],

                     ['no'=>15,'text'=>'Setting API Key per User',
                     ...
                     'img'=>'real_click_api_key_per_user.png','label'=>'API KEY MENU'],

                    ['no'=>16,'text'=>'Setting API Key Per User',
                    ...
                    'img'=>'real_api_key_list.png','label'=>'LIST API KEY'],
                ],
            ],
            [
                'id'    => 'user-rls',
                ...
                'steps' => [
                    ['no'=>17, 'text'=>'Apa itu Row Level Security?',
                    ...
                    ['no'=>18, 'text'=>'Tombol RLS — Buka Modal Filter Data',
                     ...
                     'img'=>'real_button_rls_per_user.png', 'label'=>'TOMBOL BUKA RLS'],

                    ['no'=>19, 'text'=>'Modal RLS — Daftar Tabel Terdeteksi',
                    ...
                    ['no'=>20, 'text'=>'Pilih Tabel & Tambah Kondisi Filter',
                    ...
                    ['no'=>21, 'text'=>'Preview Data & Simpan Perubahan',
            ...
            [
                ...
                'steps' => [
                    ['no'=>22, 'text'=>'Tombol Hapus User',
                     ...
                     'img'=>'real_button_delete_user.png', 'label'=>'TOMBOL HAPUS USER'],

                    ['no'=>23, 'text'=>'Konfirmasi Hapus User',
                     ...
                     'img'=>'real_confirm_delete_user.png', 'label'=>'KONFIRMASI HAPUS USER'],
                ],
            ],
        ],
    ],
...
echo "Successfully generated 7 CLEAN & TIDY chapter files with the NEW updated content.";
?>
