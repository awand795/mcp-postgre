    ...
    */
    ...
    'connections' => [
        ...
        'pgsql_mbi' => [
            'driver' => 'pgsql',
            'url' => env('DB_MBI_URL'),
            'host' => env('DB_MBI_HOST', '127.0.0.1'),
            'port' => env('DB_MBI_PORT', '5432'),
            'database' => env('DB_MBI_DATABASE', 'laravel'),
            'username' => env('DB_MBI_USERNAME', 'root'),
            'password' => env('DB_MBI_PASSWORD', ''),
            'charset' => env('DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'clickhouse' => [
            ...
            'options' => [
                'database' => env('CLICKHOUSE_DATABASE', 'default'),
                'connect_timeout' => env('CLICKHOUSE_TIMEOUT_CONNECT', 5),
