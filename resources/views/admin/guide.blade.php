    ...
    [
        ...
        'sections' => [
            [
                ...
                'steps' => [
                    ['no' => 1, 'text' => 'Buka Halaman Login', 'desc' => 'Akses URL <strong>http://74.48.112.31:5000/login</strong> melalui browser. Anda akan melihat form login dengan dua field: Email dan Password. Pastikan koneksi internet stabil sebelum melanjutkan.', 'real_img' => 'real_login_page.png', 'img_text' => 'Step 1: Halaman Login'],
                    ...
                    ['no' => 5, 'text' => 'Login Berhasil — Masuk ke Halaman Utama', 'desc' => 'Setelah login berhasil, sistem otomatis mengarahkan Anda ke <strong>halaman Chatbot</strong> sebagai halaman utama. Dari sini Anda bisa mengakses menu Admin melalui sidebar atau langsung buka URL <code>http://74.48.112.31:5000/admin/</code>. Jika muncul pesan "These credentials do not match", berarti email atau password salah.', 'real_img' => 'real_login_success.png', 'img_text' => 'Step 5: Login Sukses'],
                ]
            ]
        ]
    ],
    ...
    [
        ...
        'sections' => [
            ...
            [
                ...
                'steps' => [
                    ['no' => 19, 'text' => 'Klik Ikon Edit (Pensil)', 'desc' => 'Di kolom <strong>Aksi</strong> setiap baris user, klik ikon <strong>pensil kuning ✏️</strong> untuk membuka form edit user tersebut. Semua data user yang sudah ada akan otomatis terisi di form edit sehingga Anda hanya perlu mengubah field yang diperlukan saja.', 'real_img' => 'real_user_edit_btn.png', 'img_text' => 'Step 19: Tombol Edit'],
            ...
            [
                ...
                'steps' => [
                    ['no' => 27, 'text' => 'Tombol konfigurasi AI', 'desc' => 'Ikon otak di kolom Aksi.', 'real_img' => 'real_user_ai_btn.png', 'img_text' => 'Step 27: Tombol AI Config\nSorot Ikon Otak'],
            ...
            [
                ...
                'steps' => [
                    ['no' => 32, 'text' => 'Tombol "Generate MCP Token"', 'desc' => 'Sorot ikon kunci.', 'real_img' => 'real_user_mcp_btn.png', 'img_text' => 'Step 32: Generate Token\nSorot Ikon Kunci'],
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no' => 41, 'text' => 'Tombol "Tambah Filter"', 'desc' => 'Menambahkan kondisional ekstra.', 'real_img' => 'real_user_rls_modal.png', 'img_text' => 'Step 41: Tambah Aturan\nSorot Tombol Tambah'],
                    ['no' => 42, 'text' => 'Tombol "Preview Filter"', 'desc' => 'Uji hasil query filter.', 'real_img' => 'real_user_rls_modal.png', 'img_text' => 'Step 42: Preview Filter\nSorot Tombol Preview'],
        ...
        'sections' => [
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no' => 11, 'text' => 'Pilih Dropdown Driver', 'desc' => 'Pilih <strong>jenis sistem database</strong> yang digunakan server target. Pilihan yang tersedia saat ini: PostgreSQL, MySQL, dan MariaDB. Driver menentukan format query yang digunakan AI nantinya.', 'real_img' => 'real_db_tambah_modal_s2.png', 'img_text' => 'Step 11: Dropdown Driver'],
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no' => 25, 'text' => 'Klik Tombol Update', 'desc' => 'Klik tombol <strong>"Update"</strong> untuk menyimpan. Lakukan Test All setelah update untuk memastikan konfigurasi baru berfungsi.', 'real_img' => 'real_db_edit_btn.png', 'img_text' => 'Step 25: Tombol Update'],
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no' => 29, 'text' => 'Hasil Test: Connected', 'desc' => 'Jika berhasil, badge berubah kembali menjadi hijau <strong>"Connected"</strong> dan muncul notifikasi sukses.', 'real_img' => 'real_db_status_badge.png', 'img_text' => 'Step 29: Connected Hijau'],
            ...
            [
                ...
                'steps' => [
                    ['no' => 35, 'text' => 'Klik Ikon Mata (Lihat Schema)', 'desc' => 'Klik ikon <strong>mata 👁️</strong> di card database untuk melihat struktur tabel-tabel yang berhasil dibaca oleh sistem dari database tersebut.', 'real_img' => 'real_db_schema_btn.png', 'img_text' => 'Step 35: Tombol Schema'],
        ...
        'sections' => [
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no' => 6, 'text' => 'Isi Nama Provider', 'desc' => 'Ketik nama provider yang mudah dikenali (contoh: <code>HuggingFace</code>, <code>Local Ollama</code>). Nama ini akan tampil di UI Chatbot saat user memilih AI.', 'real_img' => 'real_add_provider_modal.png', 'img_text' => 'Step 6: Field Nama Provider'],
                    ['no' => 7, 'text' => 'Isi Kode Unik', 'desc' => 'Masukkan kode pendek tanpa spasi (contoh: <code>huggingface</code>). Kode ini digunakan oleh sistem di backend untuk merutekan request API.', 'real_img' => 'real_add_provider_modal.png', 'img_text' => 'Step 7: Kode Unik Provider'],
                    ['no' => 8, 'text' => 'Isi Base URL API', 'desc' => 'Masukkan endpoint utama dari provider tersebut (contoh: <code>https://api.huggingface.co/v1/</code>). Jika menggunakan Ollama lokal, isi dengan IP lokal (misal: <code>http://127.0.0.1:11434/v1/</code>). <strong>Pastikan URL berakhiran /v1/</strong> jika provider kompatibel dengan standar OpenAI.', 'real_img' => 'real_add_provider_modal.png', 'img_text' => 'Step 8: Base URL'],
                    ['no' => 9, 'text' => 'Klik Tombol Simpan', 'desc' => 'Klik <strong>"Simpan Provider"</strong>. Jika berhasil, card baru akan muncul di dashboard.', 'real_img' => 'real_add_provider_modal.png', 'img_text' => 'Step 9: Simpan Provider'],
                    ['no' => 10, 'text' => 'Tombol Batal', 'desc' => 'Klik "Batal" atau ikon X jika ingin membatalkan pembuatan provider.', 'real_img' => 'real_add_provider_modal.png', 'img_text' => 'Step 10: Tombol Batal'],
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no' => 13, 'text' => 'Matikan Provider (Switch OFF)', 'desc' => 'Klik switch untuk mematikannya (abu-abu). Jika dimatikan, semua model dan key dari provider ini <strong>tidak dapat diakses sementara</strong>, tapi data konfigurasi tetap aman.', 'real_img' => 'real_ai_toggle_on.png', 'img_text' => 'Step 13: Toggle OFF'],
                    ['no' => 14, 'text' => 'Visual Card Nonaktif', 'desc' => 'Saat OFF, opacity card akan sedikit menurun/redup sebagai indikasi visual bahwa provider sedang dinonaktifkan.', 'real_img' => 'real_ai_toggle_on.png', 'img_text' => 'Step 14: Card Redup'],
                ]
            ],
            [
            ...
            [
                ...
                'steps' => [
                    ['no' => 34, 'text' => 'Klik Ikon Edit (Pensil)', 'desc' => 'Di baris key yang ingin diubah, klik <strong>ikon pensil kuning ✏️</strong>.', 'real_img' => 'real_ai_edit_key_btn.png', 'img_text' => 'Step 34: Edit Key'],
            ...
            [
                ...
                'steps' => [
                    ...
                    ['no' => 59, 'text' => 'Daftar Model (Format Chip)', 'desc' => 'Model direpresentasikan sebagai <strong>kapsul/chip</strong> yang berjajar rapi. Ini memudahkan admin melihat puluhan model sekaligus dalam ruang yang ringkas.', 'real_img' => 'real_models_tab.png', 'img_text' => 'Step 59: Badge Model'],
                    ['no' => 60, 'text' => 'Model Aktif (Biru/Indigo)', 'desc' => 'Chip berwarna <strong>biru/indigo mencolok</strong> berarti model tersebut berstatus AKTIF. Model ini dapat digunakan oleh user (tergantung konfigurasi akses di pengaturan User/Role).', 'real_img' => 'real_models_tab.png', 'img_text' => 'Step 60: Model Aktif'],
                    ['no' => 61, 'text' => 'Model Nonaktif (Abu-abu)', 'desc' => 'Chip berwarna <strong>abu-abu redup</strong> berarti model dinonaktifkan (OFF). Meskipun datanya tersimpan, Chatbot akan menyembunyikan opsi ini dari end-user.', 'real_img' => 'real_models_tab.png', 'img_text' => 'Step 61: Model Mati'],
                    ['no' => 62, 'text' => 'Klik Chip untuk Toggle Cepat', 'desc' => 'Fitur <strong>Quick Toggle</strong>: Anda hanya perlu meng-klik area teks pada chip untuk langsung menyalakan (biru) atau mematikan (abu) model tersebut tanpa perlu membuka form edit. Ini sangat menghemat waktu saat mematikan massal model yang sudah usang (deprecated).', 'real_img' => 'real_models_tab.png', 'img_text' => 'Step 62: Klik Toggle'],
