                    ...
                    item.innerHTML = `
                        ...
                        <div class="table-info">
                            <div class="table-main-info" style="gap: 0.5rem; flex-wrap: wrap; align-items: center;">
                                ...
                                <span class="badge badge-type" style="${table.table_type === 'view' ? 'background: rgba(168, 85, 247, 0.2); color: #c084fc;' : 'background: rgba(148, 163, 184, 0.1); color: #94a3b8;'}">${table.engine || (table.table_type === 'view' ? 'View' : 'Table')}</span>
                            </div>
