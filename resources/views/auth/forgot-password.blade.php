...
<body class="p-6 relative">
    ...
    <div class="w-full max-w-md glass-panel p-10 rounded-3xl relative">
        <div class="flex flex-col items-center mb-8">
            ...
            <p class="text-gray-500 dark:text-[#A1A09A] text-sm mt-2 text-center">Masukkan email Anda untuk menerima OTP reset password.</p>
        </div>
        ...
        <div class="mt-8 text-center">
            <p class="text-gray-500 dark:text-[#A1A09A] text-sm">
                Ingat password Anda?
                <a href="{{ route('login') }}" class="text-[#f53003] hover:text-[#ff4433] font-semibold transition-colors">Masuk</a>
            </p>
        </div>
    </div>
</body>
