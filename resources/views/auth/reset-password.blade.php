...
<body class="p-6 relative">
    ...
    <div class="w-full max-w-md glass-panel p-10 rounded-3xl relative">
        <div class="flex flex-col items-center mb-8">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Buat Password Baru</h1>
            <p class="text-gray-500 dark:text-[#A1A09A] text-sm mt-2 text-center">Masukkan password baru untuk akun Anda.</p>
        </div>
        ...
        <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-600 dark:text-[#A1A09A] uppercase tracking-wider mb-2 ml-1">Password Baru</label>
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-600 dark:text-[#A1A09A] uppercase tracking-wider mb-2 ml-1">Konfirmasi Password Baru</label>
