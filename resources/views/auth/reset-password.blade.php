        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (resetForm && submitBtn) {
                resetForm.addEventListener('submit', () => {
                    ...
                    if (label) label.textContent = "{{ __('Menyimpan...') }}";
                });
            }
        });
    </script>
    ...
    <div class="login-card-container">
        <div class="login-card">
            ...
            <div class="card-header">
                ...
                <p>{{ __('Tentukan password baru yang kuat untuk akun Anda.') }}</p>
            </div>

            <!-- Form -->
            <form id="resetForm" action="{{ route('password.update', request()->query()) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-box">
                        ...
                        <button type="button" class="pwd-eye-btn" onclick="togglePasswordVisibility('password', 'eye-icon-1')" title="{{ __('Tampilkan/Sembunyikan password') }}">
                    ...
                    @else
                        @if(request()->query('sso_error'))
                            <p class="error-text"><i class="fas fa-circle-exclamation"></i> {{ request()->query('sso_error') }}</p>
                        @endif
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-box">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" required
                               ...
                               style="padding-right: 3rem;">
                        <button type="button" class="pwd-eye-btn" onclick="togglePasswordVisibility('password_confirmation', 'eye-icon-2')" title="{{ __('Tampilkan/Sembunyikan password') }}">
                ...
                <button type="submit" id="submitBtn" class="submit-btn">
                    ...
                    <span class="submit-label">{{ __('SIMPAN PASSWORD BARU') }}</span>
