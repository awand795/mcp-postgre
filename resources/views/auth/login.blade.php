...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Plus Jakarta Sans', sans-serif; }
        ...
        .input-box:focus-within i.lead-icon {
            color: var(--brand);
        }
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Detect if opened inside iframe
            ...
            // Animate submit button on form submission
            const loginForm = document.getElementById('loginForm');
            const submitBtn = document.getElementById('submitBtn');
            if (loginForm && submitBtn) {
                loginForm.addEventListener('submit', () => {
                    submitBtn.classList.add('loading');
                    const textEl = submitBtn.querySelector('.submit-label');
                    if (textEl) textEl.textContent = "{{ __('Memverifikasi...') }}";
                });
            }
        });
    </script>
    ...
    <div class="login-card-container">
        <div class="login-card">
            ...
            <div class="card-header">
                ...
                <p>{{ __('Masuk untuk mengakses analisis data bisnis Anda') }}</p>
            </div>
            ...
            @elseif(request()->query('sso_success'))
                <div class="alert-banner success">
                    <i class="fas fa-check-circle"></i>
                    <span>{{ request()->query('sso_success') }}</span>
                </div>
            @endif
            ...
            @if(request()->query('sso_error'))
                <div class="alert-banner error">
                    ...
                    <span>{{ request()->query('sso_error') }}</span>
                </div>
            @endif

            <!-- Form -->
            <form id="loginForm" action="{{ route('login.post', request()->query()) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-box">
                        ...
                        <button type="button" class="pwd-eye-btn" onclick="togglePasswordVisibility('password', 'eye-icon')" title="{{ __('Tampilkan/Sembunyikan password') }}">
                ...
                <div class="meta-row">
                    ...
                    <a href="{{ route('password.request', request()->query()) }}" class="link-forgot">
                        {{ __('Lupa password?') }}
                    </a>
                </div>
                ...
                <button type="submit" class="submit-btn" id="submitBtn">
                    ...
                    <span class="submit-label">{{ __('MASUK SEKARANG') }}</span>
